...
class PokeCell: UITableViewCell {
    ...
    private func setUpUI() {
        ...
        vStackRight.spacing = 16
        vStackRight.distribution = .fillEqually
        
        vStackRight.addArrangedSubview(self.SpaceLabel)
        vStackRight.addArrangedSubview(self.elementLabel)
        vStackRight.addArrangedSubview(self.SpaceLabel1)
        ...
        self.pokeImageView.heightAnchor.constraint(equalToConstant: 140).isActive = true
        self.pokeImageView.widthAnchor.constraint(equalToConstant: 140).isActive = true
